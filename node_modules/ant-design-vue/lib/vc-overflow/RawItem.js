  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      if (!context.value) {
        ...
        return (0, _vue.createVNode)(Component, _objectSpread(_objectSpread({}, _restProps), attrs), {
      ...
      return (0, _vue.createVNode)(_context.OverflowContextProvider, {
        ...
        default: function _default() {
          return [(0, _vue.createVNode)(_Item.default, _objectSpread(_objectSpread(_objectSpread({
