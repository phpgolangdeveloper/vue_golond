  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var internalRenderItemNode = renderRawItem ? function (item, index) {
        ...
        var key = getKey(item, index);
        return (0, _vue.createVNode)(_Item.default, _objectSpread(_objectSpread({}, itemSharedProps), {}, {
          "order": index,
          "key": key,
          "item": item,
      ...
      if (!renderRawRest) {
        ...
        restNode = (0, _vue.createVNode)(_Item.default, _objectSpread(_objectSpread({}, itemSharedProps), restContextProps), {
          default: function _default() {
      ...
      var overflowNode = (0, _vue.createVNode)(Component, _objectSpread({
        "class": (0, _classNames.default)(!invalidate.value && prefixCls, className),
        "style": style
      }, restAttrs), {
        default: function _default() {
          return [mergedData.value.map(internalRenderItemNode), showRest.value ? restNode : null, suffix && (0, _vue.createVNode)(_Item.default, _objectSpread(_objectSpread({}, itemSharedProps), {}, {
