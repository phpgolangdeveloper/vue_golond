...
var RangeCalendar = (0, _vue.defineComponent)({
  ...
  render: function render() {
    ...
    if (showToday) {
      ...
      TodayButtonNode = (0, _vue.createVNode)(_TodayButton.default, _objectSpread({
        "key": "todayButton"
    ...
    if (props.timePicker) {
      ...
      TimePickerButtonNode = (0, _vue.createVNode)(_TimePickerButton.default, _objectSpread({
    ...
    if (showOkButton) {
      ...
      OkButtonNode = (0, _vue.createVNode)(_OkButton.default, _objectSpread({
        "key": "okButtonNode"
      }, okButtonProps), null);
    }
