...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var wrapperClassName = (0, _classNames3.default)("".concat(pre, "-link"), _defineProperty({}, "".concat(pre, "-link-active"), active));
      var titleClassName = (0, _classNames3.default)("".concat(pre, "-link-title"), _defineProperty({}, "".concat(pre, "-link-title-active"), active));
