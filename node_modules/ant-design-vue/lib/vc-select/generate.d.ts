...
import type { GetLabeledValue, FilterOptions, FilterFunc, DefaultValueType, RawValueType, LabelValueType, Key, FlattenOptionsType, SingleType, OnClear, SelectSource, CustomTagProps, DropdownRender } from './interface/generator';
import type { OptionListProps } from './OptionList';
import type { CSSProperties, DefineComponent, VNodeChild } from 'vue';
...
export default function generateSelector<OptionsType extends {
    ...
    default: () => undefined;
} ? never : "options" : never)> | Exclude<"filterSort", "dropdownAlign" | (OptionsType extends BooleanConstructor | {
    required: true;
} | {
    default: any;
} | {
