...
var _default2 = {
  name: 'InnerSlider',
  inheritAttrs: false,
  props: _extends({}, _defaultProps.default),
  ...
  data: function data() {
    ...
    return _extends(_extends({}, _initialState.default), {
  ...
  methods: {
    ...
    ssrInit: function ssrInit() {
      ...
      if (this.variableWidth) {
        ...
        var _trackLeft = 0;
        var childrenWidths = [];
        var preClones = (0, _innerSliderUtils.getPreClones)(_extends(_extends(_extends({}, this.$props), this.$data), {
          slideCount: children.length
        }));
        var postClones = (0, _innerSliderUtils.getPostClones)(_extends(_extends(_extends({}, this.$props), this.$data), {
          slideCount: children.length
        }));
    ...
    slideHandler: function slideHandler(index) {
      ...
      var _slideHandler2 = (0, _innerSliderUtils.slideHandler)(_extends(_extends(_extends({
        index: index
      }, this.$props), this.$data), {
        trackRef: this.track,
    ...
    swipeMove: function swipeMove(e) {
      var state = (0, _innerSliderUtils.swipeMove)(e, _extends(_extends(_extends({}, this.$props), this.$data), {
        trackRef: this.track,
        listRef: this.list,
    ...
    swipeEnd: function swipeEnd(e) {
      var state = (0, _innerSliderUtils.swipeEnd)(e, _extends(_extends(_extends({}, this.$props), this.$data), {
        trackRef: this.track,
        listRef: this.list,
        slideIndex: this.currentSlide
      }));
    ...
    play: function play() {
      ...
      if (this.rtl) {
        ...
        if ((0, _innerSliderUtils.canGoNext)(_extends(_extends({}, this.$props), this.$data))) {
          nextIndex = this.currentSlide + this.slidesToScroll;
        } else {
          return false;
        }
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.lazyLoad) {
      var slidesToLoad = (0, _innerSliderUtils.getOnDemandLazySlides)(_extends(_extends({}, this.$props), this.$data));
