...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var _inject = (0, _vue.inject)(_.ListContextKey, {
      grid: (0, _vue.ref)(),
    ...
    return function () {
      ...
      var itemChildren = (0, _vue.createVNode)(Element, _objectSpread(_objectSpread({}, restAttrs), {}, {
        "class": (0, _classNames2.default)("".concat(pre, "-item"), _defineProperty({}, "".concat(pre, "-item-no-flex"), !isFlexMode()), className)
      }), {
