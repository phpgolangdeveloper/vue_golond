...
var mentionsProps = _extends(_extends({}, _mentionsProps.mentionsProps), {
...
var Mentions = (0, _vue.defineComponent)({
  ...
  render: function render() {
    ...
    var mergedClassName = (0, _classNames2.default)(className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, "".concat(prefixCls, "-focused"), focused), _classNames));
