...
declare const _default: {
    new (...args: any[]): {
        ...
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "format" | "prefixCls" | "width" | "strokeWidth" | "percent" | "successPercent" | "trailColor" | "gapDegree">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
