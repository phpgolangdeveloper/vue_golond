...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var placement = (0, _vue.computed)(function () {
      return rtl.value ? _extends(_extends({}, _placements.placementsRtl), builtinPlacements.value) : _extends(_extends({}, _placements.placements), builtinPlacements.value);
    });
    ...
    return function () {
      ...
      return (0, _vue.createVNode)(_vcTrigger.default, {
        "prefixCls": prefixCls,
        "popupClassName": (0, _classNames2.default)("".concat(prefixCls, "-popup"), _defineProperty({}, "".concat(prefixCls, "-rtl"), rtl.value), popupClassName),
