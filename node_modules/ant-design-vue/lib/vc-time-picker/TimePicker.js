...
var _default2 = (0, _vue.defineComponent)({
  ...
  methods: {
    ...
    getPopupClassName: function getPopupClassName() {
      ...
      return (0, _classNames2.default)(popupClassName, _defineProperty({}, "".concat(prefixCls, "-panel-narrow"), (!showHour || !showMinute || !showSecond) && !use12Hours), "".concat(prefixCls, "-panel-column-").concat(selectColumnCount));
    },
