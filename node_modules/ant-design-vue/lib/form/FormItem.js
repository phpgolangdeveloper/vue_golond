  ...
  setup: function setup(props, _ref) {
    ...
    var validateRules = function validateRules(options) {
      ...
      promise.catch(function (e) {
        ...
        var ers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    return function () {
      ...
      if (fieldName.value && props.autoLink && (0, _propsUtil.isValidElement)(firstChildren)) {
        ...
        firstChildren = (0, _vnode.cloneElement)(firstChildren, _extends(_extends({}, fieldId.value ? {
          id: fieldId.value
        } : undefined), {
      ...
      return (0, _vue.createVNode)(_Row.default, _objectSpread(_objectSpread({}, attrs), {}, {
        "class": [itemClassName.value, domErrorVisible.value || !!help ? "".concat(prefixCls.value, "-item-with-help") : '', attrs.class],
        "key": "row"
      }), {
        default: function _default() {
          return [(0, _vue.createVNode)(_FormItemLabel.default, _objectSpread(_objectSpread({}, props), {}, {
          ...
          }), null), (0, _vue.createVNode)(_FormItemInput.default, _objectSpread(_objectSpread({}, props), {}, {
